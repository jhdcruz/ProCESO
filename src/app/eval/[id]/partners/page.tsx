...
export async function generateMetadata({
  ...
  return {
    title: `${activity.data.title} Evaluation for Partners | T.I.P Community Extension Services Office – Manila`,
    ...
    openGraph: {
      siteName: 'ProCESO',
      url: `${siteUrl()}/eval/${activity.data.id}/partners`,
...
export default async function PartnersFeedback({
  params,
}: {
  params: Promise<{ id: string }>;
}) {
  ...
  return (
    <>
      ...
      <PartnersForm activity={activity.data} />
    </>
  );
}
